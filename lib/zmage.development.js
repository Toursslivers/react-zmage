...
function (_React$PureComponent) {
  ...
  function Portals(props) {
    ...
    _this.container.style.overflow = props.zoom ? 'scroll' : 'hidden';
  ...
  _createClass(Portals, [{
    ...
    value: function componentDidUpdate(prevProps) {
      var prevZoom = prevProps.zoom;
      var currZoom = this.props.zoom;
...
var Image_utils_getZoomingStyle = function getZoomingStyle(props, context, imageRef) {
  var _ref = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {},
      ...
      mouseY = _ref$clientY === void 0 ? 0 : _ref$clientY;
  ...
  function Image(props, context) {
      ...
      if (nextProfile) {
        _this.setState({
          ...
          var _this$context2 = _this.context,
              outBrowsing = _this$context2.outBrowsing,
              toPrevPage = _this$context2.toPrevPage,
              toNextPage = _this$context2.toNextPage;
          var touchProfile = _this.state.touchProfile;
    ...
    Image_defineProperty(Image_assertThisInitialized(_this), "getStyle", function (step, distance, isSideImage) {
      ...
      if (isSideImage) {
        ...
        transform = "translate3d(-50%, ".concat(zoom ? "-50%" : '-50%', ", 0) translate3d(").concat(x, "px, ").concat(y, "px, 0px) scale3d(").concat(currentStyle.scale + overflow, ", ").concat(currentStyle.scale + overflow, ", 1) rotate3d(0, 0, 1, 0deg)");
        zIndex = 10 * distance;
        pointerEvents = 'none';
      } else {
        ...
        transform = "translate3d(-50%, ".concat(zoom ? "-50%" : '-50%', ", 0) translate3d(").concat(_x, "px, ").concat(_y, "px, 0px) scale3d(").concat(currentStyle.scale, ", ").concat(currentStyle.scale, ", 1) rotate3d(0, 0, 1, ").concat(currentStyle.rotate, "deg)"); // clipPath = currentStyle.radius ? `inset(0% 0% 0% 0% round ${currentStyle.radius/currentStyle.scale}px)` : `inset(0% 0% 0% 0% round 0)`
  ...
  Image_createClass(Image, [{
    ...
    value: function componentDidMount() {
      ...
      var _this$context6 = this.context,
          presetIsMobile = _this$context6.presetIsMobile,
          presetIsDesktop = _this$context6.presetIsDesktop;
    ...
    value: function componentWillUnmount() {
      ...
      window.removeEventListener('resize', this.handleResize); // window.removeEventListener('mousemove', this.handleMouseMove)
    ...
    value: function render() {
      var _this$context8 = this.context,
          set = _this$context8.set,
          show = _this$context8.show,
          zoom = _this$context8.zoom,
          page = _this$context8.page,
          pageIsCover = _this$context8.pageIsCover,
          pageWithStep = _this$context8.pageWithStep;
...
function (_React$PureComponent) {
  ...
  function Browser(props) {
    ...
    Browser_defineProperty(Browser_assertThisInitialized(_this), "init", function () {
      ...
      if (!show) {
        window.addEventListener('keydown', _this.handleKeyDown); // hideOnScroll && window.addEventListener('scroll', this.handleScroll)
    ...
    Browser_defineProperty(Browser_assertThisInitialized(_this), "unInit", function () {
      ...
      if (show || force) {
        window.removeEventListener('keydown', _this.handleKeyDown); // hideOnScroll && window.removeEventListener('scroll', this.handleScroll)
